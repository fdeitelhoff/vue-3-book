...
describe("CartComposition.vue", () => {
  it("renders article names", () => {
    const { getByText } = render(CartComposition, {
      props: { articles },
    });
  ...
  it("increments articles quantity", async () => {
    const { getAllByRole, getByText } = render(CartComposition, {
      props: { articles },
    });
  ...
  it("coupon is handled properly via v-model", async () => {
    const { getByLabelText, getByText } = render(CartComposition, {
      props: { articles },
    });
  ...
  it("renders the CartComposition.vue component correctly", () => {
    const { container } = render(CartComposition, {
      props: { articles },
    });
